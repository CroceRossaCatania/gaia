...
<div class="alert alert-danger">
    ...
    <p>Qualcosa nella procedura di elaborazione non ha funzionato, per favore, riprova.</p>
</div>
<?php } ?>
...
<div class="row-fluid">
    <div class="span12">
        <div class="alert alert-block alert-info">
            <h4><i class="icon-question-sign"></i> Perchè non posso elaborare tutti gli avvisi di premiazioni in elenco?</h4>
            <p>La possibilità di elaborare gli avvisi di premiazioni di un Volontario implica che tu sia il Presidente del Comitato
        ...
        <table class="table table-striped table-bordered" id="tabellaUtenti">
            ...
            foreach($comitati as $comitato){
               foreach ( $comitato->meritiPendenti() as $_t ) {
                   $_v = $_t->volontario();
                   ?>
                   <tr>
                    <td>
                    ...
                    <td><strong><?php echo $conf['tipiDonazioni'][$_t->donazione]; ?></strong></td>
                    <td><?php echo $_t->merito; ?></td>
                    <td>  
                        <?php if($_v->modificabileDa($me)) { ?>  
                        <a class="btn btn-success btn-block" href="?p=presidente.donazione.merito.ok&id=<?php echo $_t->id; ?>&si">
                            <i class="icon-ok"></i>
                            &nbsp;Elaborata&nbsp;
                        </a>
                        <?php } ?>

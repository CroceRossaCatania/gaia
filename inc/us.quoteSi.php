   ...
   <div class="span12">
        <div class="btn-group btn-group-vertical span12">
            <?php if ( count($me->comitatiApp ([ APP_SOCI, APP_PRESIDENTE ])) > 1 ) { ?>
                <a href="?p=admin.utenti.excel&quotesi&anno=<?= $anno; ?>" class="btn btn-block btn-inverse" data-attendere="Generazione e compressione in corso...">
            ...
            <tr class="success">
                <td colspan="7" class="grassetto">
                    ...
                    <a class="btn btn-small pull-right" 
                       href="?p=presidente.utenti.excel&comitato=<?php echo $comitato->id; ?>&quotesi&anno=<?= $anno; ?>"

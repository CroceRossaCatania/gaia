            ...
            <div class="tab-pane <?php if($ctess) echo "active" ; ?>" id="tab_tesserino">
              ...
              <div class="row-fluid">
                ...
                <div class="alert alert-info">
                    <p><i class="icon-warning-sign"></i> Le funzionalita' dei tesserini non sono ancora state rilasciate, ma puoi gia' caricare la tua fototessera, rispettando gli standard ICAO riportati <i class="icon-link"></i><a href="#" target="_new"> qui!</a></p>
                  </div>

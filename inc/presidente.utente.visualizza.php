...
<div class="row-fluid">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <select class="input-small" id="inputgruppoSanguigno" name="inputgruppoSanguigno"  required class="disabled">
            <?php foreach ( $conf['sangue_gruppo'] as $numero => $gruppo ) { ?>
  ...
  <?php if ( $v->documenti() ) { ?>
    <a href="?p=presidente.utente.documenti&id=<?php echo $v->id; ?>" data-attendere="Generazione in corso...">
      <i class="icon-download-alt"></i> Scarica documenti del volontario in ZIP
    </a>
  <?php } else { ?>
    <span class="text-info">
      <i class="icon-warning-sign"></i> Il volontario non ha caricato documenti.
    </span>
  <?php } ?>
  <hr />
  ...
  <div class="span6">
    <div class="row-fluid">
      <h4>
        <i class="icon-time muted"></i> Appartenenze
      </h4>
    </div>
    <div class="row-fluid">

...
menuElenchiVolontari(
    "Volontari senior",
    "?p=admin.utenti.excel&senior",
    "?p=utente.mail.nuova&comsen"
);
        ...
        foreach($elenco as $comitato) {
            ...
            <tr class="success">
                <td colspan="7" class="grassetto">
                    ...
                    <a class="btn btn-success btn-small pull-right" href="?p=utente.mail.nuova&id=<?php echo $comitato->id; ?>&unitsen">
                           <i class="icon-envelope"></i> Invia mail
                    </a>
                    <a class="btn btn-small pull-right" 
                       href="?p=presidente.utenti.excel&comitato=<?php echo $comitato->id; ?>&senior"

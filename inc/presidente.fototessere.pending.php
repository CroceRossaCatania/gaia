        ...
        <td>
            <div class="btn-group">
                ...
                <?php if($_v->modificabileDa($me)) {?>    
                    <a class="btn btn-success btn-small" href="?p=presidente.utente.fototessera.ok&id=<?php echo $_t->id; ?>&ok">
                        <i class="icon-ok"></i> Conferma
                    </a>
                    <a class="btn btn-danger btn-small" onClick="return confirm('Vuoi veramente negare appartenenza a questo utente ?');" href="?p=ppresidente.utente.fototessera.ok&id=<?php echo $_t->id; ?>&no">

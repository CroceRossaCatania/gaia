...
<div class="row-fluid">
    <div class="span8">
        <h4>Filtri</h4>
        <select  class="chosen-select" data-placeholder="Aggiungi un filtro..." style="width:350px;" multiple="true">
        ...
        <select data-placeholder="Scegli una provincia..." required id="cercaProvicia" class="chosen-select" style="width: 350px;" multiple="true">
            <option value=""></option>

...
controllaParametri(array('inputData'), 'presidente.supervisione&err');
...
<div class="row-fluid">
    <div class="span12">
        <div class="btn-group btn-group-vertical span12">
         ...
         <a href="?p=presidente.supervisione.noturni.excel&time=<?php echo $inizio; ?>&com" class="btn btn-block btn-inverse" data-attendere="Generazione e compressione in corso...">
        ...
        foreach($comitati as $comitato){
            ...
            <tr class="success">
                <td colspan="5" class="grassetto">
                 ...
                 href="?p=presidente.supervisione.noturni.excel&c=<?php echo $comitato->id; ?>&unit&time=<?php echo $inizio; ?>"
